...
calc_CS_HTE <- function(K, CV, p=0.5, sigma2y=1, sigma2x=1, eff, alpha0, alpha1, rho0, rho1, alpha=0.05, beta=0.2){
  # Argument:
  ...
  # 
  # Output:
  # nca: number of clusters in the AB sequence
...
calc_CC_HTE <- function(K, CV, p=0.5, sigma2y=1, sigma2x=1, eff, alpha0, alpha1, alpha2, rho0, alpha=0.05, beta=0.2){
  # Argument:
  # K: mean cluster-period size
  # CV: coefficient of variance of cluster-period size
  # p: proportion of clusters randomly assigned to the AB sequence
